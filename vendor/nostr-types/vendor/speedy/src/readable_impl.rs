...
impl<'a, C: Context, T: Readable<'a, C>> Readable<'a, C> for Cow<'a, HashSet<T>>
where
    T: Readable<'a, C> + Clone + Hash + Eq,
{
    #[inline]
    fn read_from<R: Reader<'a, C>>(reader: &mut R) -> Result<Self, C::Error> {
...
impl<'a, C: Context, T: Readable<'a, C>> Readable<'a, C> for Cow<'a, BTreeSet<T>>
where
    T: Readable<'a, C> + Clone + Ord,
{
    #[inline]
    fn read_from<R: Reader<'a, C>>(reader: &mut R) -> Result<Self, C::Error> {
        Ok(Cow::Owned(reader.read_value()?))
...
impl<'a, C: Context, K: Readable<'a, C>, V: Readable<'a, C>> Readable<'a, C>
    for Cow<'a, HashMap<K, V>>
where
    K: Readable<'a, C> + Clone + Hash + Eq,
    V: Readable<'a, C> + Clone,
{
    #[inline]
    fn read_from<R: Reader<'a, C>>(reader: &mut R) -> Result<Self, C::Error> {
        Ok(Cow::Owned(reader.read_value()?))
...
impl<'a, C: Context, K: Readable<'a, C>, V: Readable<'a, C>> Readable<'a, C>
    for Cow<'a, BTreeMap<K, V>>
where
    K: Readable<'a, C> + Clone + Ord,
    V: Readable<'a, C> + Clone,
{
    #[inline]
    fn read_from<R: Reader<'a, C>>(reader: &mut R) -> Result<Self, C::Error> {
