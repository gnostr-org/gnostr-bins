	...
	P::Target: Persist<ChannelSigner>,
{
		...
		FN: Fn(&ChannelMonitor<ChannelSigner>, &TransactionData) -> Vec<TransactionOutputs>,
	{
		...
		let mut txn_outputs;
		{
			...
			let update_id =
				MonitorUpdateId { contents: UpdateOrigin::ChainSync(chain_sync_update_id) };
			...
			log_trace!(
				logger,
				"Syncing Channel Monitor for channel {} for block-data update_id {}",
			...
			match self.persister.update_persisted_channel(
				*funding_outpoint,
				...
				ChannelMonitorUpdateStatus::Completed => log_trace!(
					logger,
					"Finished syncing Channel Monitor for channel {} for block-data update_id {}",
					log_funding_info!(monitor),
					chain_sync_update_id
				),
